...
namespace Domain.Features.Records.MedicalRecord.Entities
{
    public class MedicalRecord
    {
        ...
        public MedicalRecord(Guid idficha, Guid idaluno, string alergia, string restricao, string lesao, string cirurgia, string problemaSaude, string usoMedicamento)
        {
            IdFicha = idficha;
            IdAluno = idaluno;
            Alergia = alergia;
