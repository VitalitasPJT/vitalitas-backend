...
namespace Domain.Features.Academia.Interfaces
{
    public interface IAcademiaRepository
    {
        ...
        Domain.Features.Academia.Entities.Academia ObterAcademia(Guid idAcademia);
        List<Domain.Features.Academia.Entities.Academia> ListarAcademias();
