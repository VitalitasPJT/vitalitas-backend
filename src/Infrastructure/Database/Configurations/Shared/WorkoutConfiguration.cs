...
namespace Infrastructure.Database.Configurations.Shared
{
    public class WorkoutConfiguration : IEntityTypeConfiguration<Workout>
    {
        public void Configure(EntityTypeBuilder<Workout> builder)
        {
            ...
            // comentário original da entidade Workout ("converter para o banco").
            var exercicioComparer = new ValueComparer<Dictionary<string, List<Exercise>>>(
                (a, b) => JsonSerializer.Serialize(a, (JsonSerializerOptions?)null) == JsonSerializer.Serialize(b, (JsonSerializerOptions?)null),
                v => JsonSerializer.Serialize(v, (JsonSerializerOptions?)null).GetHashCode(),
                v => JsonSerializer.Deserialize<Dictionary<string, List<Exercise>>>(
            ...
            builder.Property(t => t.Exercicio)
                .HasConversion(
                    ...
                    v => JsonSerializer.Deserialize<Dictionary<string, List<Exercise>>>(v, (JsonSerializerOptions?)null) ?? new())
